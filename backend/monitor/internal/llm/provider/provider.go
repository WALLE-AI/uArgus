...
type Provider interface {
	...
	CallModel(ctx context.Context, params CallModelParams) (<-chan llm.StreamEvent, error)
}
...
type CallModelParams struct {
	...
	ThinkingConfig *llm.ThinkingConfig `json:"thinking_config,omitempty"`
	...
	TaskBudget *llm.TaskBudget `json:"task_budget,omitempty"`
